...
public class DataBR {
	...
	public static double[] latitudes, longitudes; // length of nodeAmount, sorted by unique nodeID by array index
	...
	private static void readNodes() {
		...
		for (int ctr = 0; ctr < nodeAmount; ctr++) {
			...
			latitudes[ctr] = Double.parseDouble(tempArray[2]);
			longitudes[ctr] = Double.parseDouble(tempArray[3]);
		}
